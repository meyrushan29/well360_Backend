...
def load_model(class_names):
    ...
    try:
        ...
        # Architecture detection - Use explicit None checks (Tensors cannot be used with 'or')
        weight_1 = state_dict.get("mobilenet.classifier.1.weight")
        if weight_1 is None:
            weight_1 = state_dict.get("classifier.1.weight")
        
        weight_9 = state_dict.get("mobilenet.classifier.9.weight")
        if weight_9 is None:
            weight_9 = state_dict.get("classifier.9.weight")
        
        weight_13 = state_dict.get("mobilenet.classifier.13.weight")
        if weight_13 is None:
            weight_13 = state_dict.get("classifier.13.weight")
